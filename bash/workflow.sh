...
#  Script to execute:
            ...
            ETCD_HOME=~/workspace/shuke/1000/2000/etcd
            rm -rf $ETCD_HOME
...
echo Start provider services.
#[DEBUG] Script to execute:

            PROVIDER_HOME=~/workspace/shuke/1000/2000/provider-small
            rm -rf $PROVIDER_HOME
            ...
            PROVIDER_HOME=~/workspace/shuke/1000/2000/provider-medium
            rm -rf $PROVIDER_HOME
            mkdir -p $PROVIDER_HOME/logs
            ...
            PROVIDER_HOME=~/workspace/shuke/1000/2000/provider-large
            rm -rf $PROVIDER_HOME
            mkdir -p $PROVIDER_HOME/logs
...
echo Start consumer service.
# Script to execute:
            # noqa: E501

            CONSUMER_HOME=~/workspace/shuke/1000/2000/consumer
            rm -rf $CONSUMER_HOME
